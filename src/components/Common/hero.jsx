...
import FinanceOptions from "../Common/financebutton";
...
const DashboardHeader = ({ greetingTitle, greetingSubtitle }) => {
  ...
  return (
    <div className="relative flex flex-col lg:flex-row items-center justify-center h-auto bg-gray-50 px-4 sm:px-6 lg:px-0">
      <div
        ...
        style={{
          background:
            "linear-gradient(61deg, rgba(3,55,1,1) 25%, rgba(102,155,27,1) 100%, rgba(102,155,27,1) 450%)",
        }}
      >
        {/* Navbar */}
            ...
            <div className="relative">
              ...
              {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm z-50">
                  <div
                    className="p-6 rounded-xl shadow-2xl text-white w-80"
                    style={{
                      background:
                        "linear-gradient(61deg, rgba(3,55,1,1) 25%, rgba(102,155,27,1) 100%, rgba(102,155,27,1) 450%)",
                    }}
        ...
        <div className="mt-6 p-4 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
          <div className="text-center sm:text-left">
            ...
            <p className="text-lime-400 text-sm mt-1">{greetingSubtitle}</p>
          </div>
